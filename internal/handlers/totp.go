...
func (e *Env) HandleTOTPValidation(w http.ResponseWriter, r *http.Request) {
	...
	ticket, err := totp2.DecodeLoginTicket(rawTicket)
	if err != nil {
...
func (e *Env) handleTotpPrompt(w http.ResponseWriter, r *http.Request, loginTicket totp2.LoginTicket, errorMessage string) {
...
func (e *Env) handleTotpEnableSubmission(w http.ResponseWriter, r *http.Request) {
	...
	enrollmentTicket, err := totp2.DecodeEnrollmentTicket(encodedTicket)
	if err != nil {
...
func (e *Env) renderSetupPage(w http.ResponseWriter, r *http.Request, errorMessage string) {
	...
	if oldTicket := r.FormValue(totpEnrollmentTicketFieldName); oldTicket != "" {
		var decoded totp2.EnrollmentTicket
		decoded, err = totp2.DecodeEnrollmentTicket(oldTicket)
		if err != nil {
	...
	ticket := totp2.GenerateEnrollmentTicket(u.Id, seed.Secret())
